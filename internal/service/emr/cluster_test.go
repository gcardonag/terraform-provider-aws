...
func TestAccEMRCluster_PlacementGroupConfigs(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccClusterConfig_PlacementGroup_OptionalUnset(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "placement_group_config.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "placement_group_config.0.instance_role", "MASTER"),
...
func testAccClusterIAMServiceRoleBaseConfig_PlacementGroup(rName string) string {
	return acctest.ConfigCompose(
		fmt.Sprintf(`
resource "aws_iam_role" "emr_service" {
	name = "%[1]s_default_role"
...
func testAccClusterConfig_PlacementGroup(rName string) string {
	return acctest.ConfigCompose(
		testAccClusterBaseVPCConfig(rName, true),
		testAccClusterIAMServiceRoleBaseConfig_PlacementGroup(rName),
		testAccClusterIAMInstanceProfileBaseConfig(rName),
		testAccClusterIAMAutoScalingRoleConfig(rName),
		fmt.Sprintf(`
data "aws_partition" "current" {}
...
func testAccClusterConfig_PlacementGroup_OptionalUnset(rName string) string {
	return acctest.ConfigCompose(
		testAccClusterBaseVPCConfig(rName, true),
		testAccClusterIAMServiceRoleBaseConfig_PlacementGroup(rName),
		testAccClusterIAMInstanceProfileBaseConfig(rName),
